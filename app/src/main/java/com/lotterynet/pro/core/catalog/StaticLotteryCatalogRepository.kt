...
class StaticLotteryCatalogRepository : LotteryCatalogRepository {
    ...
    companion object {
        ...
        private val lotteries: List<LotteryCatalogItem> = listOf(
            ...
            lot("5", "Quiniela Real", "Real", "12:55 PM", "12:55", "#10b981", usesExplicitCloseTime = true),
            ...
            lot("15", "Leidsa", "Leidsa", "8:55 PM", "20:55", "#b91c1c", usesExplicitCloseTime = true, sundayOverride = LotterySchedule("3:50 PM", "15:50")),
